...
namespace TravelPro.Migrations
{
    ...
    [Migration("20260127214829_Added_ApiMetrics")]
    partial class Added_ApiMetrics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelPro.Destinations.Destination", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppDestinations", (string)null);
                });

            modelBuilder.Entity("TravelPro.Experiences.Experience", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelPro.Metrics.ApiMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelPro.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelPro.Ratings.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppRatings", (string)null);
                });

            modelBuilder.Entity("TravelPro.Watchlists.Watchlist", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelPro.Destinations.Destination", b =>
                {
                    b.OwnsOne("TravelPro.Destinations.Coordinate", "Coordinates", b1 =>
                        {
            ...
            modelBuilder.Entity("TravelPro.Ratings.Rating", b =>
                {
                    b.HasOne("TravelPro.Destinations.Destination", "Destination")
                        .WithMany()
                        .HasForeignKey("DestinationId")
