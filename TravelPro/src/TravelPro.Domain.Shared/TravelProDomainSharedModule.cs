...
public class TravelProDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        TravelProGlobalFeatureConfigurator.Configure();
        TravelProModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TravelProDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TravelProResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/TravelPro");

            options.DefaultResourceType = typeof(TravelProResource);
        ...
        {
            options.MapCodeNamespace("TravelPro", typeof(TravelProResource));
        });
    }
}
